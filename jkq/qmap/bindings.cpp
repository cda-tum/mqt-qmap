...
PYBIND11_MODULE(pyqmap, m) {
    ...
    py::class_<Configuration>(m, "Configuration", "Configuration options for the JKQ QMAP quantum circuit mapping tool")
            .def(py::init<>())
    ...
    py::class_<MappingResults>(m, "MappingResults", "Results of the JKQ QMAP quantum circuit mapping tool")
            .def(py::init<>())
