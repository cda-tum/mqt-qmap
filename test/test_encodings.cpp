...
class TestEncodings: public testing::TestWithParam<std::pair<Encoding, CommanderGrouping>> {
protected:
...
INSTANTIATE_TEST_SUITE_P(Encodings, TestEncodings,
                         testing::Values(
                                 std::pair{Encoding::Naive, CommanderGrouping::Halves},
