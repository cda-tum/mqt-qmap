...
TEST(TestCliffordSynthesis, SanityCheckGates) {
    ...
    qc::QuantumComputation qc{};
    CliffordSynthesizer    cs{};
    Configuration          configuration{false, 2, 10, OptimizationStrategy::UseMinimizer, TargetMetric::GATES};
    configuration.verbosity = 5;
    qc.addQubitRegister(2U);
    qc.h(0);
    qc.h(0);
...
TEST(TestCliffordSynthesis, SanityCheck2QubitGates) {
    ...
    qc::QuantumComputation qc{};
    CliffordSynthesizer    cs{};
    Configuration          configuration{false, 2, 10, OptimizationStrategy::UseMinimizer, TargetMetric::TWO_QUBIT_GATES};
    configuration.verbosity = 5;
    qc.addQubitRegister(2U);
    qc.x(0, 1_pc);
    qc.x(0, 1_pc);
