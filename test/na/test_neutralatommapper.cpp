...
TEST(NeutralAtomMapper, QAOA5) {
  const char*   archFn = "arch.json";
  const char*   gridFn = "grid.csv";
  const char*   circFn = "qaoa_5.qasm";
  std::ofstream archF(archFn);
  archF << "{\n"
           "    \"name\": \"Nature\",\n"
           "    \"initialZones\": [\n"
           "        \"storage\"\n"
  ...
  gridF << "x,y\n"
           ...
           "355,146\n";
  gridF.close();
  std::ofstream circuit("qaoa_5.qasm");
