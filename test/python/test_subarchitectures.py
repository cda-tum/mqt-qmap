...
def test_singleton_graph(singleton_graph):
...
def test_two_node_graph(singleton_graph):
...
def test_ibm_guadalupe_opt(ibm_guadalupe):
...
def test_ibm_guadalupe_cov(ibm_guadalupe):
