...
protected:
   ...
   */
  void initMoveGroups(qc::QuantumComputation& qc); //, qc::Permutation& hwToCoordIdx);
  /**
...
public:
  ...
  explicit MoveToAodConverter(const NeutralAtomArchitecture& archArg, const na::HardwareQubits& hardwareQubitsArg)
      : arch(archArg), qcScheduled(arch.getNpositions()), hardwareQubits(hardwareQubitsArg) {}
   ...
   */
  qc::QuantumComputation schedule(qc::QuantumComputation& qc); //, qc::Permutation hwToCoordIdx);
