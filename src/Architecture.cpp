...
qc::OpType Architecture::opTypeFromString(const std::string& operation) {
  if (operation == "i" || operation == "id") {
    return qc::OpType::I;
  }
  if (operation == "h" || operation == "ch") {
    return qc::OpType::H;
  }
  if (operation == "x" || operation == "cx" || operation == "cnot") {
    return qc::OpType::X;
  }
  if (operation == "y" || operation == "cy") {
    return qc::OpType::Y;
  }
  if (operation == "z" || operation == "cz") {
    return qc::OpType::Z;
  }
  if (operation == "s" || operation == "cs") {
    return qc::OpType::S;
  }
  if (operation == "sdg" || operation == "csdg") {
    return qc::OpType::Sdag;
  }
  if (operation == "t" || operation == "ct") {
    return qc::OpType::T;
  }
  if (operation == "tdg" || operation == "ctdg") {
    return qc::OpType::Tdag;
  }
  if (operation == "u3" || operation == "cu3" || operation == "u" ||
      operation == "cu") {
    return qc::OpType::U3;
  }
  if (operation == "u2" || operation == "cu2") {
    return qc::OpType::U2;
  }
  if (operation == "u1" || operation == "cu1" || operation == "p" ||
      operation == "cp") {
    return qc::OpType::Phase;
  }
  if (operation == "sx" || operation == "csx") {
    return qc::OpType::SX;
  }
  if (operation == "sxdg" || operation == "csxdg") {
    return qc::OpType::SXdag;
  }
  if (operation == "rx" || operation == "crx") {
    return qc::OpType::RX;
  }
  if (operation == "ry" || operation == "cry") {
    return qc::OpType::RY;
  }
  if (operation == "rz" || operation == "crz") {
    return qc::OpType::RZ;
  }
  if (operation == "swap" || operation == "cswap") {
    return qc::OpType::SWAP;
  }
  if (operation == "iswap") {
    return qc::OpType::iSWAP;
  }
  if (operation == "dcx") {
    return qc::OpType::DCX;
  }
  if (operation == "ecr") {
    return qc::OpType::ECR;
  }
  if (operation == "rxx") {
    return qc::OpType::RXX;
  }
  if (operation == "ryy") {
    return qc::OpType::RYY;
  }
  if (operation == "rzz") {
    return qc::OpType::RZZ;
  }
  if (operation == "rzx") {
    return qc::OpType::RZX;
  }
  if (operation == "xx_minus_yy") {
    return qc::OpType::XXminusYY;
  }
  if (operation == "xx_plus_yy") {
    return qc::OpType::XXplusYY;
  }
  if (operation == "measure") {
    return qc::OpType::Measure;
  }
  if (operation == "reset") {
    return qc::OpType::Reset;
  }
