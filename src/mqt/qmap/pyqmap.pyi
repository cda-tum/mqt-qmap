...
class Heuristic:
    __members__: ClassVar[dict[InitialLayout, int]] = ...  # read-only
    gate_count_max_distance: ClassVar[InitialLayout] = ...
    gate_count_sum_distance: ClassVar[InitialLayout] = ...
    gate_count_sum_distance_minus_shared_swaps: ClassVar[InitialLayout] = ...
    gate_count_max_distance_or_sum_distance_minus_shared_swaps: ClassVar[InitialLayout] = ...
    fidelity_best_location: ClassVar[InitialLayout] = ...
    @overload
    def __init__(self, value: int) -> None: ...
    @overload
    def __init__(self, arg0: str) -> None: ...
