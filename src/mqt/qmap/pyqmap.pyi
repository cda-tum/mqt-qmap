...
class AZACArchitecture:
    """Class representing the zoned neutral atom architecture used for AZAC."""
    def __init__(self, properties: dict[str, Any]) -> None: ...

class AZACompiler:
    """Class representing the Advanced Zoned Atom Compiler (AZAC)."""
    def __init__(self, arch: AZACArchitecture, settings: dict[str, Any]) -> None: ...
