...
class Configuration:
    ...
    layering: Layering
    maximum_active_qubits: int
    maximum_active_qubits_1q_gates: int
    maximum_active_qubits_2q_gates: int
...
class InitialLayout:
    ...
    dynamic_greedy_lookahead: ClassVar[InitialLayout] = ...
...
class LookaheadHeuristic:
    ...
    fidelity_current_location: ClassVar[LookaheadHeuristic] = ...
    fidelity_current_target_location: ClassVar[LookaheadHeuristic] = ...
    @overload
    def __init__(self, value: int) -> None: ...
    @overload
    def __init__(self, arg0: str) -> None: ...
...
class Layering:
    ...
    disjoint_same_op_type_blocks: ClassVar[Layering] = ...
    @overload
    def __init__(self, value: int) -> None: ...
    @overload
    def __init__(self, arg0: str) -> None: ...
