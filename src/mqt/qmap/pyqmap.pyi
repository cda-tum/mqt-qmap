...
class SynthesisResults:
    ...
    @property
    def mapping(self) -> list[list[bool]]: ...
    @property
    def mapping_string(self) -> str: ...
...
class CliffordSynthesizer:
    ...
    @overload
    def __init__(
        self, initial_tableau: Tableau, target_tableau: Tableau, coupling_map: set[tuple[int, int]]
    ) -> None: ...
    @overload
    def __init__(self, target_tableau: Tableau, coupling_map: set[tuple[int, int]]) -> None: ...
    @overload
    def __init__(self, qc: QuantumComputation, coupling_map: set[tuple[int, int]], use_destabilizers: bool) -> None: ...
    @overload
    def __init__(
        self, initial_tableau: Tableau, qc: QuantumComputation, coupling_map: set[tuple[int, int]]
    ) -> None: ...
