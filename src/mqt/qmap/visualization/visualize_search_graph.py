...
def visualize_search_graph(
    ...
    if not hide_layout:
        ...
        x_diff = (
            full_plotly_settings["architecture_xaxis"]["range"][1]
            - full_plotly_settings["architecture_xaxis"]["range"][0]
        )  # type: ignore[index]
        y_diff = (
            full_plotly_settings["architecture_yaxis"]["range"][1]
            - full_plotly_settings["architecture_yaxis"]["range"][0]
        )  # type: ignore[index]
        if x_diff == 0:
